...
class Test(common_methods.CommMethod):
    def run(self):
        ...
        # build msg
        msg = API_device_management.build_msg_get_device_list_by_family(common_para_dict, device_category_id=0)
