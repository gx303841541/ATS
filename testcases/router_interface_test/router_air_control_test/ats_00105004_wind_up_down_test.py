...
class Test(common_methods.CommMethod):
    def run(self):
        ...
        # build msg
        login_msg = API_air_control.build_msg_wind_up_down(common_para_dict, 'on')
        ...
        # build msg
        login_msg = API_air_control.build_msg_wind_up_down(common_para_dict, 'off')
        ...
        if 'device_uuid' in result[1]:
            if not re.search(r'"wind_up_down":"off"', result[1]['attribute']):
                return self.case_fail("wind off fail!")
        else:
